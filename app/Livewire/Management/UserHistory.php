...
class UserHistory extends Component implements HasActions, HasSchemas, HasTable
{
    ...
    {
        return $table
            ->query(fn (): Builder => User::onlyTrashed())
            ->columns([
                ...
                TextColumn::make('deleted_at')->label('Deleted At')->dateTime('d M Y, H:i')->sortable(),
            ])
            ...
            ->recordActions([
                ...
                Action::make('forceDelete')
                    ...
                    ->modalHeading('Delete User Permanently')
    ...
    {
        return view('livewire.management.user-history');
    }
}
